...
from datasus_metadata.transferencia.extract import (
    ...
    extract_modalidade,
    extract_modalidade_datasus,
    extract_modalidade_territorial,
...
def main():
    ...
    modalidades_datasus = extract_modalidade_datasus(transferenciajs)
    modalidades_territorial = extract_modalidade_territorial(transferenciajs)
    ...
    save_json(modalidades_datasus, dest_dir / "modalidades_datasus.json")
    save_json(modalidades_territorial, dest_dir / "modalidades_territorial.json")
